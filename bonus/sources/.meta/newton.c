...
// 		point.axis[0] = data->spheres[sphere_num].origin_vect.axis[0];
// 		point.axis[1] = data->spheres[sphere_num].origin_vect.axis[1];
// 		point.axis[2] = data->spheres[sphere_num].origin_vect.axis[2];
